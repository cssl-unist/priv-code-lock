...
/* 32 bit ELF emulation code for elf32lriscv
...
static void gldelf32lriscv_before_parse (void);
static void gldelf32lriscv_after_open (void);
static void gldelf32lriscv_before_allocation (void);
static void gldelf32lriscv_after_allocation (void);
...
{
  gldelf32lriscv_before_allocation ();
...
static void
gldelf32lriscv_after_allocation (void)
{
  int need_layout = 0;
...
static void
gldelf32lriscv_before_parse (void)
{
...
static void
gldelf32lriscv_after_open (void)
{
...
static void
gldelf32lriscv_before_allocation (void)
{
...
static char *
gldelf32lriscv_get_script (int *isfile)
{
  *isfile = 0;
...
static bfd_boolean
gldelf32lriscv_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
struct ld_emulation_xfer_struct ld_elf32lriscv_emulation =
{
  gldelf32lriscv_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32lriscv_after_open,
  after_check_relocs_default,
  gldelf32lriscv_after_allocation,
  set_output_arch_default,
  ldemul_default_target,
  riscv_elf_before_allocation,
  gldelf32lriscv_get_script,
  "elf32lriscv",
  "elf32-littleriscv",
  finish_default,
