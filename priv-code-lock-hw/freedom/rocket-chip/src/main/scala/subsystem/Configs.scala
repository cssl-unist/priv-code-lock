...
class WithPrivCodeLock1 extends Config((site, here, up) => {
  case RocketTilesKey => up(RocketTilesKey, site) map { r =>
    r.copy(
      core = r.core.copy(
        hasPrivCodeLock = true,
        numPCodeRanges = 1
        )
    )
  }
...
class WithPrivCodeLock extends Config((site, here, up) => {
  case RocketTilesKey => up(RocketTilesKey, site) map { r =>
    r.copy(
      core = r.core.copy(
        hasPrivCodeLock = true,
...
class WithPrivCodeLock3 extends Config((site, here, up) => {
  case RocketTilesKey => up(RocketTilesKey, site) map { r =>
    r.copy(
      core = r.core.copy(
        hasPrivCodeLock = true,
...
class WithPrivCodeLock2 extends Config((site, here, up) => {
  case RocketTilesKey => up(RocketTilesKey, site) map { r =>
    r.copy(
      core = r.core.copy(
        hasPrivCodeLock = true,
