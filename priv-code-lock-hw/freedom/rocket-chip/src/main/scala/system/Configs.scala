...
class DefaultConfig extends Config(new WithNBigCores(4) ++ new BaseConfig)
class DefaultPCLConfig extends Config(new WithPrivCodeLock ++ new DefaultConfig)
class DefaultPCL1Config extends Config(new WithPrivCodeLock1 ++ new DefaultConfig)
class DefaultPCL2Config extends Config(new WithPrivCodeLock2 ++ new DefaultConfig)
class DefaultPCL3Config extends Config(new WithPrivCodeLock3 ++ new DefaultConfig)
