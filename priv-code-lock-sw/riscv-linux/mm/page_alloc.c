...
static inline void __m_s __free_one_page(struct page *page,
		unsigned long pfn,
...
static void __m_s free_one_page(struct zone *zone,
...
static void __m_s __free_pages_ok(struct page *page, unsigned int order)
{
	unsigned long flags;
	int migratetype;
	unsigned long pfn = page_to_pfn(page);
...
static bool __m_s free_unref_page_prepare(struct page *page, unsigned long pfn)
{
	int migratetype;
...
static void __m_s free_unref_page_commit(struct page *page, unsigned long pfn)
{
 ...
 * Free a 0-order page
 */
void __m_s free_unref_page(struct page *page)
{
	unsigned long flags;
	unsigned long pfn = page_to_pfn(page);
...
static inline struct page * __m_s
...
static inline bool __m_s prepare_alloc_pages(gfp_t gfp_mask, unsigned int order,
...
void __m_s __free_pages(struct page *page, unsigned int order)
{
