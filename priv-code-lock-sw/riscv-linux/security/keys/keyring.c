 ...
 */
static int __m_s keyring_search_iterator(const void *object, void *iterator_data)
{
 ...
 */
static int __m_s search_keyring(struct key *keyring, struct keyring_search_context *ctx)
{
 ...
 * depth.
 */
static bool __m_s search_nested_keyrings(struct key *keyring,
 ...
 */
key_ref_t __m_s keyring_search_aux(key_ref_t keyring_ref,
			     struct keyring_search_context *ctx)
{
	struct key *keyring;
	long err;
 ...
 */
key_ref_t __m_s keyring_search(key_ref_t keyring,
