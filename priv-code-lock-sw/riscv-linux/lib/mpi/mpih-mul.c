...
void __m_s mpih_sqr_n_basecase(mpi_ptr_t prodp, mpi_ptr_t up, mpi_size_t size)
{
	mpi_size_t i;
	mpi_limb_t cy_limb;
	mpi_limb_t v_limb;
...
void __m_s mpihelp_release_karatsuba_ctx(struct karatsuba_ctx *ctx)
{
