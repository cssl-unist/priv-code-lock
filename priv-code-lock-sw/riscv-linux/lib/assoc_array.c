 ...
 * or better.
 */
static int __m_s assoc_array_subtree_iterate(const struct assoc_array_ptr *root,
 ...
 */
int __m_s assoc_array_iterate(const struct assoc_array *array,
 ...
 */
static enum assoc_array_walk_status __m_s 
 ...
 */
void __m_s *assoc_array_find(const struct assoc_array *array,
		       const struct assoc_array_ops *ops,
		       const void *index_key)
{
	struct assoc_array_walk_result result;
 ...
 */
static void __m_s assoc_array_destroy_subtree(struct assoc_array_ptr *root,
					const struct assoc_array_ops *ops)
{
	struct assoc_array_shortcut *shortcut;
	struct assoc_array_node *node;
 ...
 */
void __m_s assoc_array_destroy(struct assoc_array *array,
			 const struct assoc_array_ops *ops)
{
 ...
 */
static bool __m_s assoc_array_insert_in_empty_tree(struct assoc_array_edit *edit)
{
 ...
 */
static bool __m_s assoc_array_insert_into_terminal_node(struct assoc_array_edit *edit,
						  const struct assoc_array_ops *ops,
						  const void *index_key,
						  struct assoc_array_walk_result *result)
{
 ...
 */
static bool __m_s assoc_array_insert_mid_shortcut(struct assoc_array_edit *edit,
					    const struct assoc_array_ops *ops,
					    struct assoc_array_walk_result *result)
{
 ...
 */
struct assoc_array_edit __m_s *assoc_array_insert(struct assoc_array *array,
					    const struct assoc_array_ops *ops,
					    const void *index_key,
					    void *object)
{
